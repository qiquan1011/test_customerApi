...
queryAllSkillGroup_excel=commom.get_excel("testCase.xlsx","queryAllSkillGroup")
@paramunittest.parametrized(*queryAllSkillGroup_excel)
class queryAllSkillGroup(unittest.TestCase):
    def setUp(self):
        pass
    ...
    def test_queryAllSkillGroup(self):
