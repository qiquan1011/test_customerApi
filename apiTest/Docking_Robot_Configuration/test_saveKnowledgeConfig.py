...
saveKnowledgeConfig_excel=commom.get_excel("testCase.xlsx","saveKnowledgeConfig")
@paramunittest.parametrized(*saveKnowledgeConfig_excel)
class evaluationConfigSave(unittest.TestCase):
    ...
    def test_saveKnowledgeConfig(self):
