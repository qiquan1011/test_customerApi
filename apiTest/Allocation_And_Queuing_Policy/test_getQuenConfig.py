...
getQueueConfig_excel=commom.get_excel("testCase.xlsx","getQueueConfig")
@paramunittest.parametrized(*getQueueConfig_excel)
class savaWorkTime(unittest.TestCase):
    ...
    def test_getQuenconfig(self):
        ...
        local_Config_Http.get_parm(self.parameter.encode(encoding="utf-8"))
